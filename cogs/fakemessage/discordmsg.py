...
FONTSIZE = 25
DEFAULTFONT = FreeTypeFont(os.getcwd() + "/files/discordfonts/gothic.ttf", size=FONTSIZE-5)
...
async def discordMsg(picture: Image.Image, message: str, user: str, color: str = "#8e9b9b") -> Image.Image:
